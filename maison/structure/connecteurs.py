...
from build123d import Align, Box, Compound, Cylinder, Part, Pos, Shape
...
@dataclass(frozen=True, slots=True)
class SabotEWH219_91:
    """Étrier Simpson Strong-Tie EWH219/91 pour poutre en I 90 × 220.
    ...
    def __post_init__(self) -> None:
        ...
        if self.largeur_interieure != 91 or self.hauteur != 219:
            raise ValueError(
                "la référence EWH219/91 mesure obligatoirement 91 × 219 mm"
            )
    ...
    def article_bom(self) -> ArticleBOM:
        return ArticleBOM(
            reference="SIMPSON-EWH219-91",
            designation="Étrier pour poutre en I EWH219/91",
